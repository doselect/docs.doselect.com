...
Date             | Description
---------------  | -----------
Nov 27, 2017 | Added API to [reset an invite](#reset-an-invite), added `start_time` to the [create invite api](#create-a-new-invite), and added `redirection_url` to the [test resource](#test-api)
